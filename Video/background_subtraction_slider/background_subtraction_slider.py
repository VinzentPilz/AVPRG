...
#FCallback-Funktion für den Slider
def changeThreshold(trackbarValue):
    global threshold
    threshold = trackbarValue
...
while cap.isOpened():
    ...
    if frameCount == 0:
        ...
        #Slider
        cv2.createTrackbar("Threshold", "Background Model", 0, 127, changeThreshold)
        cv2.setTrackbarPos("Threshold", "Background Model", threshold)
